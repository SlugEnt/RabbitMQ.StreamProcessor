...
namespace SlugEnt.StreamProcessor
{
    public class MqStreamProducer : MQStreamBase, IMqStreamProducer
    {
        ...
        /// <returns></returns>
        protected virtual async Task SendMessageToMQAsync(Message message)
        {
        ...
        /// <summary>
        /// Sends the given message to the MQ Stream.  If false is returned you should ensure the producer is connected and CircuitBreaker not tripped.
        /// </summary>
        /// <param name="message"></param>
        /// <returns>False if it failed to send message</returns>
        public async Task<bool> SendMessageAsync(Message message)
        {
            return await SendMessageAsync(message, false);
        }
